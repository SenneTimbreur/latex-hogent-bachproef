...
\begin{figure}[H]
    ...
    \caption[\centering Homepage with search bar]{\label{fig:homepage-with-search-Mendix} Homepage with search bar Mendix}
\end{figure}
...
\begin{listing}[H]
    ...
    \end{minted}
    \caption{Repository clonen of bijwerken}
